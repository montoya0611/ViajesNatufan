...
import "./Amazonas.css";
import { PlanesAsia } from "../../components/Planes";
import Footer from "../../components/Footer";
import { CardPromoCartagena } from "../../components/Cardpromo";
import Asiav from "../../imagenes/Asia.gif";
import Navbar from "../../components/navbar";
function Asia() {
  return (
    <div className="container-amazonas">
      <Navbar />
      <img src={Asiav} type="video/mp4" className="Videos" />
      <div className="container-tittle-global">
        <h5 className="text-global">Asia</h5>
